...
int main() {
    ...
    cout << "vec size is : " << sv.size() << endl;
    cout << "vec capacity is : " << sv.capacity() << endl;

    sv.push_back("hellodidi");
    sv.push_back("hellojiaqi");

    cout << "\nafter push_back two elements: " << endl;
    cout << "vec size is : " << sv.size() << endl;
    cout << "vec capacity is : " << sv.capacity() << endl;

    sv.push_back("helleworld");

    cout << "\nafter push_back another one element: " << endl;
    cout << "vec size is : " << sv.size() << endl;
    cout << "vec capacity is : " << sv.capacity() << endl;

    cout << "\nshow what's in StrVec: " << endl;
    sv.printElems();
    ...
    cout << "\nthe last element is : " << *sv.end() << endl;
