#ifndef _14_7_STRING_H_
#define _14_7_STRING_H_
...
String::String(const String &rhs) {
    std::cout << "[call func] : copy-constructor String(const String&)"
              << std::endl;
...
String &String::operator=(const String &rhs) {
    std::cout
        << "[call func] : copy-assignment-operator operator=(const String&)"
        << std::endl;
...
String::String(String &&s) noexcept {
    std::cout << "[call func] : move-constructor String(String &&)"
              << std::endl;
...
String &String::operator=(String &&s) noexcept {
    std::cout << "[call func] : move-assignment-operator operator=(String&&)"
              << std::endl;
    if (this != &s) {
        free();
        content = std::move(s.content);
